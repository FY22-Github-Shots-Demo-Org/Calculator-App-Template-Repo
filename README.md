...
Calculator ships regularly with new features and bug fixes. You can get the latest version of Calculator in the [Microsoft Store App](https://www.microsoft.com/store/apps/9WZDNCRFHVN5).
